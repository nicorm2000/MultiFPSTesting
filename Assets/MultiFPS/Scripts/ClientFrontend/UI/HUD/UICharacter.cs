...
namespace MultiFPS.UI.HUD
{
    ...
    public class UICharacter : MonoBehaviour
    {
        ...
        private CharacterInstance _myObservedCharacter;
        ...
        void Awake ()   
        {
            ...
            ClientFrontend.ClientFrontendEvent_OnObservedCharacterSet += AssignCharacterStatsToUI;
        ...
        {
            if (!GameManager.GetHealthInstance(victimID)) return;
