...
namespace MultiFPS
{
    ...
    public class RoomCreator : MonoBehaviour
    {
        ...
        void ServeGame()
        {
            ...
            WebRequestManager.Instance.Post("/createGame", gameProperties, OnGameServed, OnFail);
            ...
            void OnGameServed(string data, int code)
            {
                ...
                if (connectInfo.Address == "X") 
                {
                    ShowLoadingScreen("Reached maximum amount of games at the time, please search for existing games", 4f);
                    return;
                }
